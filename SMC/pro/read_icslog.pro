...
readcol_multi, file, compress = compress, $
...
icslog={icslog, sysclock_s:0L, sysclock:0D, tz:-3, sysstatus:0., ccdtemp:0., $
    ...
    fw_pos: -1, fw_valid: -1, fw_moving_cw: -1, fw_moving_ccw: -1, fw_direction: -1, fw_go: -1}
...
icslog.fw_direction=getbit(dioa_out, 1)
icslog.fw_go=getbit(dioa_out, 2)
