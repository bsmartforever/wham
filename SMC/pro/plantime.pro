...
;
;NOTE: Chile is now (2015 ->) on daylight savings all the time (UTC-3). 
;         CLST is now CLT as of April, 2015.
...
;-
 ...
 calib_name=['G194_0', 'G144_0', 'G300_0', 'Lockman', 'Spica_HII', 'Crab', 'NAN', 'l_ori', 'l_ori_off', 'zeta_oph', 'zeta_oph_offa', 'zeta_oph_offb', 'south_gal_pole','faint_89_-71','faint_60_-67']
  ...
  ;; 2015 - Chile staying on CLST (daylight savings time) year-round, renamed CLT
  ...
  print, systime(/utc, /julian) - obs.tz/24.0, format = '("Current time is ", C(CHI2.2, ":", CMI2.2, ":", CSI2.2), " CLT")'
...
;	when block wraps around l=0/360
        ...
        print, lines[i], npoints[bnum-1], starttime+plan - obs.tz/24.0, $
