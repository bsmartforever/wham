pro readcol50,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15, $
...
;
; CALLING SEQUENCE:
;       READCOL50, name, v1, [ v2, v3, v4, v5, ...  v50 , COMMENT=
...
;
;       /SILENT - Normally, READCOL50 will display each line that it skips over.
...
;                printed as READCOL50 attempts to read and interpret the file.
...
;       IDL> READCOL50,'position.dat',F=FMT,name,hr,min,sec,deg,dmin,dsec  
;
...
;       floating point.
;
;       IDL> READCOL50,'position.dat',F='A',name,hr,min,sec,deg,dmin,dsec 
;
;       To read just the variables HR,MIN,SEC
;       IDL> READCOL50,'position.dat',F='X,I,I,F',HR,MIN,SEC
;
; RESTRICTIONS:
...
;		Modified to allow up to 50 variables  Alex S. Hill August, 2008
;-
  On_error,2                           ;Return to caller
  compile_opt idl2

  if N_params() lt 2 then begin
     print,'Syntax - READCOL50, name, v1, [ v2, v3,...v50, '
