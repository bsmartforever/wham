...
;
;   $Id: pxperfect.pro,v 1.3 2011/06/28 15:25:14 cmarkwar Exp $
;
;-
; Copyright (C) 2010-2011 Craig Markwardt
...
function pxperfect, landscape=landscape, scale_factor=scale0, $
  ...
  rescale_fact = 1
  if n_elements(xsize0) NE 0 AND n_elements(ysize0) then begin  ;; XSIZE and YSIZE
