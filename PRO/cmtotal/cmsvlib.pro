...
;   1.0 - initial release
;   1.1 - 28 Jun 2003 - CMSV_RREC - added NOTICE record type
;   1.2 - 07 Mar 2006 - CMSV_RVTYPE - avoid reserved word INHERITS
;   1.3 - 27 Mar 2006 - CMSV_WDATA - add support to write bytes & empty
;         strings
;   1.4 - 16 Nov 2009 - CMSV_RREC - NEXTREC field is ULONG
;   1.5 - 22 Nov 2009 - CMSV_RDATA - clarify & speed some code
;   1.6 - 11 Jan 2010 - CMSV_RREC - read 64-bit files
    version = '1.6'  ;; NOTE: modify this when incrementing version number
;
; $Id: cmsvlib.pro,v 1.6 2010/01/11 08:58:13 craigm Exp $
;
;-
; Copyright (C) 2000-2001, 2009, 2010, Craig Markwardt
