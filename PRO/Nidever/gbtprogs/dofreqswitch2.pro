...
;
; @version $Id: dofreqswitch.pro,v 1.2 2006/06/21 20:15:28 bgarwood Exp $
;-

pro dofreqswitch2,sigwcal,sig,refwcal,ref,smoothref,$
                 tsys=tsys,tau=tau,tcal=tcal,sigResult=sigResult, refResult=refResult,rfi=rfi
    compile_opt idl2

    ; take average of cal-on and cal-off spectra
    ;  and calculate Tsys
    ...
    ; this does the (sig-ref)/ref bit
    ;dosigref,sigResult,sigTP,refTP,smoothref
    ;dosigref,refResult,refTP,sigTP,smoothref
    dosigref2,sigResult,sigTP,refTP,smoothref,rfi=rfi
    dosigref2,refResult,refTP,sigTP,smoothref,rfi=rfi
