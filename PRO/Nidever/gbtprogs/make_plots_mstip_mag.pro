pro make_plots_mstip_mag,bigcube,head
...
file = plotdir+'grid_mstip_mag_coldens_velcut'
ps_open,file,/color,thick=5,/encap
device,/inches,xsize=13,ysize=7
;device,/cmyk
...
displayc,col3c,mlon,mlat,min=-1.2,max=1.2,/xflip,posim=posim,poscol=poscol,xtit='MS Longitude',$
...
file = plotdir+'grid_mstip_mag_coldens_velsigcut'
ps_open,file,/color,thick=5,/encap
device,/inches,xsize=13,ysize=7
;device,/cmyk
...
displayc,col3d,mlon,mlat,min=-1,max=3,/xflip,posim=posim,poscol=poscol,xtit='MS Longitude',$
;         ytit='MS Latitude',charsize=charsize,tit='MS Velocities and 3'+textoidl('\sigma')+' cut',maskv=0
         ytit='MS Latitude',charsize=charsize,tit='HI Column Density',maskv=0,/interp
