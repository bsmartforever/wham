...
;
; USAGE:
;  IDL>srcmatch,xarr1,yarr1,xarr2,yarr2,dcr,ind1,ind2,/sph
;
...
;
; USAGE:
;  IDL>srcmatch,xorig1,yorig1,xorig2,yorig2,dcr,ind1,ind2
;
; By D.Nidever   April 2007
;-
...
if nx1 eq 0 or ny1 eq 0 or nx1 eq 0 or ny1 eq 0 then begin
  print,'Syntax - srcmatch,xarr1,yarr1,xarr2,yarr2,dcr,ind1,ind2,sph=sph,stp=stp'
  return
endif
  ...
  for i=0,my-1. do begin
    ...
    for j=0,mx-1. do begin
      ...
      if (ngd1 gt 0) and (ngd2 gt 0) then begin
        ...
        SRCOR2,xarr1[gd1],yarr1[gd1],xarr2[gd2],yarr2[gd2],dcr,match1,match2,sph=spherical,opt=1
