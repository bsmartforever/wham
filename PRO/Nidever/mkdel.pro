...
for k=0,nf-1 do begin
  ...
  ; Read the .als file
  READCOL,aalsfile[k],id1,x1,y1,amag,amagerr,sky,it,chi,sharp,format='I,F,F,F,F,F,F,F,F',skip=3,/silent
  nstars = n_elements(id1)

  ; Read the .tot file
  READCOL,atotfile[k],id2,x2,y2,tmag,tmagerr,format='I,F,F,F,F',skip=3,/silent

  ; Matching them
  DOUBLES2,id1,id2,ind1,ind2,count=nind1
  id3 = id1[ind1]
  amag2 = amag[ind1]
  tmag2 = tmag[ind2]
