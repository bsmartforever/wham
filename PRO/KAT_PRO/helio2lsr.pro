pro helio2lsr, vhelio, vlsr, ra = ra, dec = dec, glon=glon, glat=glat,$
               g = g, reverse = reverse, $
...
; Oct 2013, Dr. Kat Barger
;               Now accpets glon and glat, which depends on galactc.pro.
;
...
;If supplied glon and glat, convert to ra and dec
if ((NOT keyword_set(ra)) AND (NOT keyword_set(dec))) AND $
    ((keyword_set(glon)) AND (keyword_set(glat)))  then $
