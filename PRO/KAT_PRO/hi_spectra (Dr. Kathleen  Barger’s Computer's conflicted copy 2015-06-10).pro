function hi_spectra, glon, glat, radius=radius, save=save, spe=spe, hi_data=hi_data,no_ave=no_ave, num=num
...
for i=0, num-1 do begin
   ...
   if (NOT keyword_set(hi_data)) then begin
      hi_data=exthi(glon_min,glon_max,glat_min,glat_max,/wham,/quiet,datadir='/d/data/hi/LAB/')
      var_flag=-1
   endif
