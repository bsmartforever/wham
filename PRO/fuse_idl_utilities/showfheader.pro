pro plotit,x,y,ystep,charsize,text,linenum	;actual plotting
	xyouts,x,y-linenum*ystep,text,/device,charsize=charsize
end

pro showfheader, x, y, fitsheader, image, charsize=charsize, $
...
;	 NOSEGMENT keywords.
;	22 July 2003 Added NOROOTNAME, NOTARGET, NOID keywords.
;-
...
;Smearing:
	...
	ystep = !d.y_ch_size*charsize*1.2
