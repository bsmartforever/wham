...
;   COMMENT - Addes a comment to the first line of the file.
;
; OPTIONAL OUTPUTS:
;
; COMMENTS:
...
;    5-Feb-2014 Added comment keyword - Dr. Kat Barger
;-
;------------------------------------------------------------------------------
pro writecol, file, v1, v2, v3, v4, v5, v6, v7, v8, v9, $
              v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, $
              FMT=fmt, FILNUM=filnum,comment=comment
...
; writecol -- Writes a 2 column ascii file
  ...
  if (N_params() LT 2) then begin 
    print,'Syntax - ' + $
             'writecol, file, v1, [v2-v19] FMT=, FILNUM= '
    return
  endif 
...
;
  ...
  if keyword_set(comment) then printf, filnum, FORMAT='(A)', comment
