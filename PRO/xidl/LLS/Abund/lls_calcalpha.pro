...
;      endif 
      ;; Si limits
      lls[nn].flg_Alpha = nelc[14]
      if lls[nn].flgAlpha NE 0 then begin
          lls_calcabnd, lls, nn, 14, 1, ans, sig, NOSIGY=NOHSIG
          goto, jump1
      endif
      return
      ...
      stop
      ;; Si value
      if lls[nn].flgAlpha GT (-4) then begin
          lls_calcabnd, lls, nn, l4, 1, ans, sig, NOSIGY=NOHSIG
      endif else begin
          case lls[nn].flgAlpha of
