...
;------------------------------------------------------------------------------
; gmos_iraftoidl, 'IRaw/gsN*.fits.gz'
pro gmos_iraftoidl, infil, rawdir, CLOBBER=clobber;, GSKLUDGE=gskludge
...
;      invv[*,rawspec-2:rawspec+ygap1+2] = 0.
;      invv[*,2*rawspec+ygap1-2:2*rawspec+ygap1+ygap2+2] = 0.
