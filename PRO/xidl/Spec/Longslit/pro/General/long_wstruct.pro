...
;; Case for upgraded red channel gratings, using sky lines
        ...
        '600-6310': begin
            ...
            wstruct.AUTOID      = 0
            wstruct.REID        = 1
            wstruct.REID_FILE   = calib_path + '/mmt_red_600.sav'
            wstruct.LINELIST    = line_path + '/mmt_red_600.lst'
        END
;; old red channel 
        'R150': BEGIN
...
;            wstruct.REID_FILE   = calib_path + '/GMOS_CuAr_R150_multislit.sav'
            ...
            wstruct.fweight     = 1L
            wstruct.BIN_RATIO     = float(binning[1])/2L ;arxiv soln binned spectrally by 2
        END
;        'R150+_G5306': BEGIN
        'R150': BEGIN
...
;         'R400+_G5305': BEGIN
         'R400': BEGIN
            ...
            wstruct.mxoff[0:4]  = [5.0, 5.0, 3.0, 3.0, 3.0]/binning[1]
            wstruct.sigrej[0:4] = [3.0, 3.0, 3.0, 3.0, 3.0]
            wstruct.nord[0:4]        = [4L, 4L, 4L, 4L, 4L]
            wstruct.nord_reid[0:4]        = [4L, 4L, 4L, 4L, 4L]
            wstruct.FLG_QUAL_REID[0:4]    = [1L, 1L, 1L, 2L, 2L]
            wstruct.FLG_QUAL[0:4]    = [1L, 1L, 1L, 2L, 2L]
            wstruct.npanic      = 15L
            wstruct.nord_panic  = 2L
