...
; <LI> N_INTEGRATION, the number of integrations, long integer
...
;    (Hz)
; <LI> N_CHANNELS, the number of channels in each spectra.
...
; </pre>
;
; @version $Id: scan_info.pro,v 1.13 2007/04/13 20:47:38 bgarwood Exp $
;-
