...
; <p><b>Parameters</b>
;
; <p>The scan number is a required parameter.  Either scan in the "Nod"
...
; provided as the scan parameter here.  The first Tsys printed is the
; tsys value in the result.  This is a weighted average of the Tsys
; values in the reference beams from both scans as described in
; <a href="../toolbox/donod.html">donod</a>  The other 4 Tsys values
...
;
; @version $Id: getbs.pro,v 1.34 2008/02/12 22:28:42 bgarwood Exp $
;-
