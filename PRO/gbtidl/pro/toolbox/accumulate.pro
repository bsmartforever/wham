...
; users.
; 
; <p>The data is : sum(wt*data)
; <p>The times are :  sum(teff), sum(tint)
; <p>The wt is : sum(wt)
; <p>The tsys_sq is :  sqrt(sum(max(wt)*Tsys^2))
...
; @private
;
; @version $Id: accumulate.pro,v 1.8 2005/12/02 20:33:44 bgarwood Exp $ 
;-
