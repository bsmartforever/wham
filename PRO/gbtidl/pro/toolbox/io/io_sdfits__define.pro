...
; @inherits io 
;
; @version $Id: io_sdfits__define.pro,v 1.95 2011/04/14 16:41:04 bgarwood Exp $
;-
...
PRO IO_SDFITS::set_project_create_index_file, file_paths
    ...
    for i = 0, n_elements(fits_files)-1 do begin
        ...
        ; update the master index file with the auxillary index file
...
; non-zero beam offsets should be applied and the positions adjusted accordingly.
; @uses IO_SDFITS::get_fits
...
;-
PRO IO_SDFITS::unflag, id, all=all
    compile_opt idl2, hidden

    self.flags->unflag, id, all=all
