...
PRO SDFITS::create_sdfits_file, file_name
    ...
    fxhmodify, self.file_name,'fitsver','1.7','FITS definition version'
...
;tdim6 = '('+string(data_points)+',1,1,1)'
   ...
   ; has to be an anonymous structure if length of data array varys
   row = { $
   ...
   SAMPLER:STRING(replicate(32B,sizes.sampler)), $ ;         STRING    'A9     '
   FEED:1S, $ ;            INT              1
   SRFEED:0S, $ ;          INT              0
