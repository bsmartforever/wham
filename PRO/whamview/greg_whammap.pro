...
;                    1 / cos((abs(maxlat) > abs(minlat))/!radeg)) < 360
  ...
  ;; Below was for NSF WHAM Movie
  ;;!P.Font = 1
  ;;DEVICE, set_font = 'Times Bold', /tt_font
  ;;XYOUTS, .5, .9, 'The WHAM Survey', charsize = 5, alignment = 0.5, /normal
  ;;DEVICE, set_font = 'Courier Bold', /tt_font
  ;;XYOUTS, .5, .825, title, /normal, charsize = 2.5, alignment = 0.5
  ;;!P.Font = -1
  ...
  IF NOT keyword_set(nodata) THEN BEGIN 
    ...
    ENDIF ELSE BEGIN 
      ...
      ;; Reverse the colors
      IF keyword_set(reverse) THEN bimage = 255-bimage
      ...
      IF keyword_set(smooth) THEN BEGIN 
        ...
        IF keyword_set(fill) THEN $
          fillmapgreg, mlon, mlat, bimage, missing
