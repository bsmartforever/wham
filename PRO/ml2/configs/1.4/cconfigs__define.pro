...
; allocate a pointer for the axes labels
axes_labels2d=ptr_new(/allocate_heap)
axes_labels3d=ptr_new(/allocate_heap)
...
struct={ cconfigs, $
         ...
         axes_labels2d:axes_labels2d, $ ; labels for the cimwin axes
         axes_labels3d:axes_labels3d, $ ; labels for the cimwin axes
