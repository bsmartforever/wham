...
; MaNGA should have LOG10 type wave solution
if (ctype3 eq 'LOG10') then begin
  wavelength_length=crpix3
  logstart_wavelength=crval3-cd3*(wavelength_length-1)
  wave10=logstart_wavelength+cd3*findgen(crpix3)
